...
import com.demo.baidu.search.RouteLineAdapter;
...
public class RoutePlanDemo extends BaseActivity implements BaiduMap.OnMapClickListener,
    ...
    private AutoCompleteTextView startKeyWorldsView = null;//起点输入窗口
    private ArrayAdapter<String> startSugAdapter = null;
    private AutoCompleteTextView endKeyWorldsView = null;//终点输入窗口
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(getResources().getString(R.string.demo_name_route));
        // 初始化地图
        ...
        startKeyWorldsView = (AutoCompleteTextView) findViewById(R.id.searchstartkey);
        endKeyWorldsView = (AutoCompleteTextView) findViewById(R.id.searchendkey);
        startSugAdapter = new ArrayAdapter<String>(this,
                android.R.layout.simple_dropdown_item_1line);
        startKeyWorldsView.setAdapter(startSugAdapter);
        startKeyWorldsView.setThreshold(1);

        endSugAdapter = new ArrayAdapter<String>(this,
                android.R.layout.simple_dropdown_item_1line);
    ...
    public void searchButtonProcess(View v) {
        ...
        if (TextUtils.isEmpty(inputEndAddr)){
            Toast.makeText(RoutePlanDemo.this, "请输入终点。", Toast.LENGTH_SHORT).show();
            return;
        }
        PlanNode stNode = null;
        if (TextUtils.isEmpty(inputStartAddr) || inputStartAddr.equals("我的位置")){
