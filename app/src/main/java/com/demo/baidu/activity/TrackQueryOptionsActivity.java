...
import com.demo.baidu.dialog.DateDialog;
...
public class TrackQueryOptionsActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(getResources().getString(R.string.track_query_options_title));
        trackApp = (DemoApplication) getApplication();
        init();
    }
