...
import com.demo.baidu.bean.CurrentLocation;


import java.util.List;

import static com.demo.baidu.utils.BitmapUtil.bmEnd;
import static com.demo.baidu.utils.BitmapUtil.bmStart;
...
public class MapUtil {
     ...
     * @param trackApp
     */
    public void setCenter(DemoApplication trackApp) {
        if (!CommonUtil.isZeroPoint(CurrentLocation.latitude, CurrentLocation.longitude)) {
            LatLng currentLatLng = new LatLng(CurrentLocation.latitude, CurrentLocation.longitude);
    ...
    public void updateStatus(LatLng currentPoint, boolean showMarker) {
        ...
        if (null != baiduMap.getProjection()) {
            ...
            if (screenPoint.y < 200 || screenPoint.y > DemoApplication.screenHeight - 500
                    || screenPoint.x < 200 || screenPoint.x > DemoApplication.screenWidth - 200
                    || null == mapStatus) {
